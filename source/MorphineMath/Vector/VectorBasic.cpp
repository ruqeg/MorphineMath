 ...
 *		Определение 7.
 *			Произведением вектора a на вещественное число α называется вектор b, удовлетворяющий следующим условиям.
 *				а) |b| = |α| |a|;
 *				б) b коллинеарен a;
 ...
 *		Определение 8. 
 *			Непустое множество векторов, замкнутое относительно линейных операций, называется векторным пространством. 
 ...
 *	Теоремы.
 *		Теорема 1.
 *			Система из одного вектора линейно зависима тогда и только тогда, когда это — нулевой вектор.
